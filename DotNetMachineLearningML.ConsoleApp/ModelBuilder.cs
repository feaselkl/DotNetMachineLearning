...
using DotNetMachineLearningML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace DotNetMachineLearningML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\fease\Downloads\twitter-airline-sentiment\Tweets2.csv";
        private static string MODEL_FILEPATH = @"../../../../DotNetMachineLearningML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.5768726f, L1Regularization = 0.1947342f, OptimizationTolerance = 0.0001f, HistorySize = 5, MaximumNumberOfIterations = 1630269273, InitialWeightsDiameter = 0.5371192f, DenseOptimizer = false, LabelColumnName = "airline_sentiment", FeatureColumnName = "Features" });
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "airline_sentiment");
